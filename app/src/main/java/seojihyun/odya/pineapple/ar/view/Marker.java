...
abstract public class Marker implements Comparable<Marker> {
    ...
    protected String title;	// 타이틀 = user_name
    protected String user_phone; // User 전화번호
...
//	private MixVector oMarker = new MixVector();
    ...
    public Marker(String title, String user_phone, double latitude, double longitude, double altitude, String link, DataSource.DATASOURCE datasource) {
        super();
        ...
        this.user_phone = user_phone; // 2015-05-03 서지현
    }
...
//	}
    ...
    public void drawCircle(PaintScreen dw) {
        ...
        if (isVisible) {
            ...
            dw.paintCircle(cMarker.x, cMarker.y, (float)70);
