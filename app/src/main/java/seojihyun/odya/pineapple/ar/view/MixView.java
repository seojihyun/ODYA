...
//	private Vector<String> listURL;
    ...
    public void maintainMap() {
        ...
        mapLayout.setMinimumWidth(3000);
        ...
        //2016-04-11 서지현 구글맵 연동 테스트

        addContentView(mapLayout, new FrameLayout.LayoutParams(
    ...
    public void maintainUserInfo() {
        ...
        addContentView(userInfoLayout, new FrameLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.RIGHT));
        //***끝
...
//				hardFix.setAltitude(180);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        item1.setIcon(android.R.drawable.sym_def_app_icon);
