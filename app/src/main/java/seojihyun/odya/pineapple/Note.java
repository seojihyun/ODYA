...
public class Note {
	...
	public Note(Context context, String title, String note, String info) { // 서지현
		this.title = title;
		this.note = note;
		this.info = info;
		NoteInfo i = new NoteInfo("", 0);
		infoImage = i.infoImage;
		this.color = getRandomColor(context);
	}
	...
	private static NoteInfo getRandomInfo(Context context) {
		NoteInfo[] infos = new NoteInfo[] { getRandomDate(context) }; //서지현 수정
	...
	public static Note getNoteFromFindapple(Context context, String title, String note) {
