...
#실행 화면
## 1. Map tab
현재 그룹원들의 위치정보를 지도에 보여주고, 해당 마커 클릭시 전화 연결, 위치안내(AR) 기능을 제공합니다.
...
![ScreenShot](https://github.com/seojihyun/ODYA/blob/master/screenshot/User-1.png)
...
(2) 목적지 공지 : 가이드와 여행객들간의 약속장소나 일정 장소등 위치 정보를 공지하는 기능
